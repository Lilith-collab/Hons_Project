...
ggplot(gg_avg_rgr_length, aes(x = factor(Week), y = RGR_Per, fill = Treatment)) +
  ...
  labs(
  title = expression("Specific Growth Rate of " * italic("Gracilaria gracilis") * " by Treatment and Week"),
    x = "Week",
    y = "SGR (%)",
    fill = "Treatment"
  ) +
...
ggplot(gl_avg_rgr_length, aes(x = factor(Week), y = RGR_Per, fill = Treatment)) +
  ...
  scale_fill_grey(start = 0.3, end = 0.8) + 
  labs(
title = expression("Specific Growth Rate of " * italic("Gracilariopsis longissima") * " by Treatment and Week"),
    x = "Week",
    y = "SGR (%)",
    fill = "Treatment"
  ) +
